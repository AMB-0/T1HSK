...
\footnotesize
\begin{table}[ht]
\caption{Binary Tree Traverse Results part1} 					% title of Table
...
\begin{table}[ht]
\caption{Binary Tree Traverse Results part2}				% title of Table
\centering 									% used for centering table
\begin{tabular}{c c c} 							% centered columns (3 columns)
\hline\hline 									%inserts double horizontal lines
Tree Id & Number of Nodes & Total Steps\\ [0.5ex] 			% inserts table
...
48 & 69 & 136 \\
49 & 51 & 100 \\
50 & 66 & 130 \\ [1ex] 						% [1ex] adds vertical space
\hline %inserts single line
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
